...
class Game:
    ...
    def _start_game(self):
        "Start a game once play button is pressed or P key is pressed"
    ...
    def _update_aliens(self):
        ...
        #Look for alien-robot collisions.
        if pygame.sprite.spritecollideany(self.robot, self.aliens):
            self._robot_hit()
    ...
    def _robot_hit(self):
        " " "Respond to the robot being hit by an alien" " "
        if self.stats.robots_left > 0:
            ...
            # Create a new fleet and center the robot.
            self._create_fleet()
            self.robot.center_robot()
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat this the same as if the robot was hit.
                self._robot_hit()
                break
